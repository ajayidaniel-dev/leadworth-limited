...
const jobs = [
  {
    ...
    description:
      "We are seeking an experienced HR Consultant to join our dynamic team...",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Join our recruitment team to help organizations find the best talent...",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Help organizations develop their workforce through effective training programs...",
    requirements: [
  ...
  },
  {
    ...
    description:
      "Drive business growth and expand our client base across Nigeria...",
    requirements: [
...
export default function CareersPage() {
  ...
  const locations = ["All", "Ibadan", "Lagos", "Remote"];
