                ...
                <div id={sectionIds[6]}>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      ...
                      Analytics to monitor website performance. This service may
                      use cookies to track your interactions. For more details
                      on how Google manages this data, please refer to the
                      Google Analytics Privacy Policy.
                    </li>
                    <li>
                      <strong>Data Integrity:</strong> We maintain a strict
                      policy against the sale of any personal information
                      collected via our website to third parties.
                    </li>
                  </ul>
                  <p className="mt-4">
