          ...
          <div className="space-y-10 text-gray-700">
            ...
            <div>
              ...
              <p className="mb-4">
                ...
                supervisor with a formal justification.
              </p>
              <p className="mb-4">
                All policy exceptions are subject to approval by the Data
                Protection Officer and legal counsel. Furthermore, a litigation
                hold may be implemented by the legal department in rare
                instances, overriding standard destruction protocols to preserve
