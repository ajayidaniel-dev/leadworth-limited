        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-sm">
              Empowering organizations with innovative HR solutions and expert
              consulting services.
            </p>
            {/* Social Links */}
            ...
            <form className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-[#F45625] transition-colors duration-300"
                />
              </div>
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full px-6 py-3 bg-[#F45625] text-white rounded-lg font-semibold hover:bg-[#e04a1f] transition-colors duration-300"
              >
                Subscribe
              </motion.button>
            </form>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} LeadWorth Consulting Limited. All
              rights reserved.
            </p>
